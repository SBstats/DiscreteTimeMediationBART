...
txt.title = paste0("param_simu_results/Results_ARIC_Stan_Param_MissModels_result.txt")
if (run_ID == 1) {
...
end_time <- Sys.time()
cat("Stan model fit time is :",end_time - start_time, ".\n")
...
end_time1 <- Sys.time()
cat("G-comp time is :",end_time1 - start_time1, ".\n")
